...
import com.androboy.tedtalkreplica.adapters.TrendingVideoListAdapter;
import com.androboy.tedtalkreplica.delegates.VideoListDelegate;

public class FragmentTrending extends Fragment implements VideoListDelegate {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TrendingVideoListAdapter adapter = new TrendingVideoListAdapter(this);
