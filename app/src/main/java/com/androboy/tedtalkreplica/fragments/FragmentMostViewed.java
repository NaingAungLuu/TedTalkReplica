...
import com.androboy.tedtalkreplica.adapters.MostViewedVideoListAdapter;
...
public class FragmentMostViewed extends Fragment implements VideoListDelegate {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MostViewedVideoListAdapter adapter = new MostViewedVideoListAdapter(this);
    ...
    public void onTapVideo() {
        Toast.makeText(getContext(), "This is the Fragment Most Viewed", Toast.LENGTH_SHORT).show();
    }
}
